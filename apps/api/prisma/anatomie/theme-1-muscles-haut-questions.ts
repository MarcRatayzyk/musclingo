...
export const THEME_1_QUIZZES: SeedQuestion[][] = [
  ...
  // 6. Avant-bras et prise
  bank25([
    [
      "Pourquoi la série d’un tirage s’arrête-t-elle parfois alors que le dos a encore de la réserve ?",
      "Parce que les mains lâchent : le maillon faible, c’est souvent la prise",
      [
        "Parce que le grand droit lâche en premier",
        "Parce que le deltoïde moyen bloque le tirage",
        "Parce que le transverse ouvre la main",
      ],
      "Dos encore capable, barre qui glisse : la prise d’avant-bras limite le tirage.",
    ],
    [
      "La prise, concrètement, c’est surtout…",
      "L’avant-bras",
      ["Le mollet", "Le sternum", "Le grand fessier"],
      "Serrer la barre, c’est le travail des muscles d’avant-bras (et de la main), pas du dos lui-même.",
    ],
    [
      "Où se trouvent les fléchisseurs de l’avant-bras ?",
      "Sur la face interne",
      [
        "Sur la face externe (côté tennis elbow)",
        "Le long des érecteurs uniquement",
        "Sous le grand pectoral",
      ],
      "Face interne : ils serrent les doigts et plient le poignet. Face externe = extenseurs.",
    ],
    [
      "Que font les fléchisseurs de l’avant-bras ?",
      "Ils serrent les doigts et plient le poignet",
      [
        "Ils ouvrent la main et redressent le poignet",
        "Ils étendent le dos",
        "Ils ramènent le bras devant",
      ],
      "Serrer + fléchir le poignet = face interne, origine fréquente près de l’épicondyle médial.",
    ],
    [
      "Près de quelle bosse du coude naissent la plupart des fléchisseurs ?",
      "L’épicondyle médial (bosse interne)",
      [
        "L’épicondyle latéral (bosse externe)",
        "La mastoïde",
        "Le grand trochanter",
      ],
      "Médial = dedans. C’est l’ancrage habituel des fléchisseurs. Latéral = extenseurs, tennis elbow.",
    ],
    [
      "Où se trouvent les extenseurs de l’avant-bras ?",
      "Sur la face externe",
      [
        "Sur la face interne, près de l’épicondyle médial",
        "Dans le bas du dos",
        "Autour du ventre",
      ],
      "Face externe : ils ouvrent la main et redressent le poignet, depuis l’épicondyle latéral.",
    ],
    [
      "Que font les extenseurs de l’avant-bras ?",
      "Ils ouvrent la main et redressent le poignet",
      [
        "Ils serrent les doigts et plient le poignet",
        "Ils fléchissent le tronc",
        "Ils rétractent les omoplates",
      ],
      "Ouverture et extension de poignet. Surchargés, c’est le tableau du tennis elbow.",
    ],
    [
      "D’où partent les extenseurs ?",
      "De l’épicondyle latéral",
      [
        "De l’épicondyle médial",
        "Du sacrum",
        "De la clavicule uniquement",
      ],
      "Latéral = dehors. Quand ces tendons sont surmenés : tennis elbow.",
    ],
    [
      "Le « tennis elbow », c’est surtout…",
      "Des extenseurs surmenés près de l’épicondyle latéral",
      [
        "Des fléchisseurs près de l’épicondyle médial",
        "Une nuque raide de l’élévateur",
        "Une faiblesse du grand dorsal",
      ],
      "Nom usuel de la surcharge des extenseurs au bord externe du coude.",
    ],
    [
      "La prono-supination (orienter la paume) dépend aussi…",
      "De muscles de l’avant-bras",
      [
        "Uniquement du grand droit",
        "Uniquement des érecteurs",
        "Uniquement du dentelé",
      ],
      "Tourner la paume n’est pas qu’une affaire de biceps : des muscles d’avant-bras orientent la main.",
    ],
    [
      "Quel muscle d’avant-bras renforce la flexion du coude ?",
      "Le brachio-radial",
      ["Le transverse", "Le grand rond", "Le scalène"],
      "Déjà croisé au curl marteau : le brachio-radial aide à plier le coude, en plus du rôle d’avant-bras.",
    ],
    [
      "Rowings, soulevés, tractions : que entraînent-ils déjà, en plus du dos ?",
      "La prise",
      ["Uniquement le six-pack", "Uniquement le deltoïde antérieur", "Le mollet seul"],
      "Chaque tirage est déjà un travail de grip. Un travail dédié n’est utile que si la prise limite encore.",
    ],
    [
      "Si la prise limite encore tes séries, que propose la leçon ?",
      "Un travail dédié : tenues lourdes, farmer walk",
      [
        "Uniquement des crunchs",
        "Uniquement des écartés",
        "Arrêter tous les tirages",
      ],
      "Tenues et farmer walk paient vite quand le grip, pas le dos, coupe la série.",
    ],
    [
      "Quelle distinction est juste entre fléchisseurs et extenseurs ?",
      "Interne / médial / serrer-plier vs externe / latéral / ouvrir-redresser",
      [
        "Les deux naissent à l’épicondyle latéral",
        "Les fléchisseurs font le tennis elbow, les extenseurs la prise",
        "Les extenseurs sont à la face interne",
      ],
      "Deux faces, deux bosses du coude, deux actions opposées sur doigts et poignet.",
    ],
    [
      "Épicondyle médial et épicondyle latéral : comment les retenir ?",
      "Médial = fléchisseurs (interne) ; latéral = extenseurs (tennis elbow)",
      [
        "Médial = tennis elbow ; latéral = serrer les doigts",
        "Les deux servent uniquement à étendre le dos",
        "Aucun n’est une origine de muscles d’avant-bras",
      ],
      "Médial = dedans, flexion/prise. Latéral = dehors, extension, tennis elbow.",
    ],
    [
      "Tu tiens une barre lourde : quels muscles ferment surtout les doigts ?",
      "Les fléchisseurs, face interne, épicondyle médial",
      [
        "Les extenseurs, épicondyle latéral",
        "Le dentelé antérieur",
        "Le SCM",
      ],
      "Grip = serrer. C’est le camp des fléchisseurs, pas celui qui ouvre la main.",
    ],
    [
      "Douleur au bord externe du coude après beaucoup d’extensions de poignet : leçon ?",
      "Extenseurs surmenés = tennis elbow (épicondyle latéral)",
      [
        "Fléchisseurs médiaux uniquement",
        "Érecteurs du rachis",
        "Grand pectoral",
      ],
      "Le nom « tennis elbow » est accroché à cette origine latérale des extenseurs.",
    ],
    [
      "Pourquoi un farmer walk aide-t-il un tirage limité par les mains ?",
      "Il charge spécifiquement la prise, maillon faible fréquent",
      [
        "Il isole le grand droit en flexion",
        "Il remplace le grand dorsal",
        "Il plaque l’omoplate en overhead",
      ],
      "Tenir une charge longtemps, c’est le grip. La leçon le couple aux tenues lourdes.",
    ],
    [
      "Le brachio-radial relie cette leçon à celle des bras parce qu’il…",
      "Renforce la flexion du coude tout en étant un muscle d’avant-bras",
      [
        "Tend le coude comme le triceps",
        "Fait la largeur du dos",
        "Hausse l’épaule",
      ],
      "Même muscle qu’en curl marteau : avant-bras + flexion de coude, ici rappelé avec la prono-supination.",
    ],
    [
      "Faut-il toujours ajouter du grip dédié ?",
      "Non : les tirages entraînent déjà la prise ; le dédié sert si elle limite encore",
      [
        "Oui, le dos n’entraîne jamais les mains",
        "Oui, uniquement des crunchs pour le grip",
        "Non, la prise n’influence jamais un rowing",
      ],
      "D’abord les tirages. Ensuite seulement tenues et farmer, si les mains lâchent trop tôt.",
    ],
    [
      "Pronation et supination, dans cette leçon, servent à rappeler que…",
      "Orienter la paume, c’est aussi l’avant-bras",
      [
        "Seul le grand dorsal tourne la paume",
        "Le poignet ne bouge jamais",
        "Le transverse fait la supination"
      ],
      "Fil du parcours : prono-supination = muscles d’avant-bras, avec le brachio-radial en renfort de flexion.",
    ],
    [
      "Redresser le poignet (le ramener en arrière) est le travail des…",
      "Extenseurs, face externe",
      [
        "Fléchisseurs, face interne",
        "Érecteurs du rachis",
        "Rhomboïdes",
      ],
      "Redresser / ouvrir = extenseurs. Plier / serrer = fléchisseurs.",
    ],
    [
      "La « bosse interne du coude » citée pour les fléchisseurs, c’est…",
      "L’épicondyle médial",
      ["L’épicondyle latéral", "La mastoïde", "L’acromion seul"],
      "Interne = médial. Point d’origine le plus fréquent des fléchisseurs de doigts et de poignet.",
    ],
    [
      "Quelle phrase relie grip et performance de dos ?",
      "Si les mains lâchent, la série s’arrête même si le dos a de la réserve",
      [
        "Le grip n’a aucun lien avec rowings, soulevés ou tractions",
        "Seul le transverse ferme les doigts",
        "Un tennis elbow vient des fléchisseurs médiaux",
      ],
      "Maillon faible : avant-bras. D’où l’intérêt de le renforcer quand il bride les tirages.",
    ],
    [
      "Quelle synthèse est fidèle ?",
      "Fléchisseurs interne/médial ; extenseurs externe/latéral (tennis elbow) ; grip = farmer / tenues si besoin",
      [
        "Tout l’avant-bras naît au latéral ; le grip ne limite jamais",
        "Les fléchisseurs ouvrent la main ; le brachio-radial étend le dos",
        "Prono-supination = uniquement le grand pec",
      ],
      "Deux faces, deux épicondyles, orientation de la paume, brachio-radial, et grip qui peut couper un tirage.",
    ],
  ]),

  // 7. Cou et muscles cervicaux
  bank25([
    [
      "Tu tournes la tête vers la gauche : quel muscle ressort surtout à droite du cou ?",
      "Le sterno-cléido-mastoïdien (SCM)",
      ["Le grand dorsal", "Le triceps", "Le transverse"],
      "Le SCM superficiel se dessine du côté opposé à la rotation : tête à gauche, relief à droite.",
    ],
    [
      "D’où va le SCM, et jusqu’où ?",
      "Du sternum et de la clavicule jusqu’à la mastoïde",
      [
        "Du bas du dos jusqu’à l’humérus",
        "Des cervicales au coin de l’omoplate seulement",
        "De l’épicondyle médial aux doigts",
      ],
      "Sternum + clavicule → os derrière l’oreille (mastoïde). Le nom « sterno-cléido-mastoïdien » dit le trajet.",
    ],
    [
      "La mastoïde, c’est…",
      "L’os derrière l’oreille, insertion du SCM",
      [
        "La bosse interne du coude",
        "Le bord interne de l’omoplate",
        "Une vertèbre lombaire",
      ],
      "Point d’arrivée du SCM. Pas un épicondyle, pas une omoplate.",
    ],
    [
      "Contracté d’un seul côté, que fait le SCM ?",
      "Il tourne et incline la tête",
      [
        "Il fléchit seulement les deux côtés à la fois",
        "Il tend le coude",
        "Il rétracte les omoplates",
      ],
      "Unilatéral = rotation + inclinaison. Bilatéral = flexion du cou vers l’avant.",
    ],
    [
      "Les deux SCM ensemble favorisent surtout…",
      "La flexion du cou vers l’avant",
      [
        "L’extension du genou",
        "Le haussement d’épaule isolé",
        "La pronation de l’avant-bras",
      ],
      "Bilatéral : les deux tirent vers sternum/clavicule et fléchissent le cou en avant.",
    ],
    [
      "Que relient les scalènes ?",
      "Les vertèbres cervicales aux premières côtes",
      [
        "Le sternum à la mastoïde",
        "Le sacrum au crâne",
        "Le sternum à l’humérus",
      ],
      "Plus profonds que le SCM : cervicales → 1ères côtes. Inclinaison + aide à l’inspiration.",
    ],
    [
      "Quel double rôle ont les scalènes ?",
      "Incliner le cou et aider à soulever les côtes à l’inspiration",
      [
        "Tendre le coude et serrer les doigts",
        "Faire la largeur du dos",
        "Dessiner le six-pack",
      ],
      "Cou (inclinaison) et respiration haute (premières côtes relevées) : les deux sont dans la leçon.",
    ],
    [
      "Les scalènes aident à inspirer en…",
      "Soulevant les premières côtes",
      [
        "Fléchissant le tronc comme un crunch",
        "Tendant le poignet",
        "Rapprochant les omoplates",
      ],
      "Insertion costale : grandes inspirations, ils aident à lever les 1ères côtes.",
    ],
    [
      "À l’arrière du cou, que font les muscles profonds ?",
      "Ils maintiennent la tête droite — un travail permanent",
      [
        "Ils tendent le coude",
        "Ils poussent horizontalement",
        "Ils serrent uniquement les doigts",
      ],
      "La tête pèse plusieurs kilos. Cette nappe postérieure profonde la tient, surtout si elle part en avant.",
    ],
    [
      "Pourquoi ces muscles postérieurs profonds travaillent-ils tout le temps ?",
      "Parce que la tête pèse plusieurs kilos, et davantage dès qu’elle part en avant",
      [
        "Parce qu’ils remplacent le grand pectoral",
        "Parce qu’ils font le V du dos",
        "Parce qu’ils n’ont aucun rôle postural",
      ],
      "Charge permanente + levier plus dur tête en avant : d’où l’intérêt de ne pas casser le cou.",
    ],
    [
      "En musculation, quand le cou travaille-t-il plus qu’on ne croit ?",
      "À chaque soulevé de terre, shrug et gainage",
      [
        "Uniquement pendant les curls biceps",
        "Jamais, il n’a aucun rôle",
        "Seulement en développé couché isolé du pec",
      ],
      "DL, shrugs, gainage : le cou se gaine. D’où la consigne d’alignement.",
    ],
    [
      "Quelle consigne utile pour le cou en musculation ?",
      "Le garder dans le prolongement du dos, ni écrasé contre la poitrine, ni cassé vers l’arrière",
      [
        "Le tasser contre le sternum à chaque répétition",
        "Le casser en hyperextension pour « voir le plafond »",
        "L’ignorer : il ne participe pas",
      ],
      "Une ligne : cou dans l’axe du dos. Ni flexion forcée, ni cassure arrière.",
    ],
    [
      "Quelle distinction est juste entre SCM unilatéral et bilatéral ?",
      "Un côté : tourne et incline ; les deux : fléchit vers l’avant",
      [
        "Un côté : fléchit seulement ; les deux : tournent uniquement",
        "Les deux cas tendent le coude",
        "Le SCM n’agit jamais des deux côtés",
      ],
      "Même muscle, deux régimes : asymétrique (rotation/inclinaison) vs couple (flexion).",
    ],
    [
      "Quelle distinction est juste entre SCM et scalènes ?",
      "SCM : sternum/clavicule → mastoïde, superficiel ; scalènes : cervicales → côtes, plus profonds",
      [
        "Les scalènes vont à la mastoïde ; le SCM aux premières côtes",
        "Les deux s’insèrent sur l’humérus",
        "Le SCM aide surtout à serrer les doigts",
      ],
      "Trajets différents, profondeurs différentes, rôles qui se recoupent un peu sur l’inclinaison seulement.",
    ],
    [
      "Inclinaison du cou : qui peut y participer d’après la leçon ?",
      "Le SCM (unilatéral) et les scalènes",
      [
        "Uniquement le biceps",
        "Uniquement les érecteurs du bas du dos",
        "Le grand pectoral seul",
      ],
      "SCM d’un côté et scalènes inclinent. Le SCM ajoute la rotation ; les scalènes ajoutent l’inspiration.",
    ],
    [
      "Pourquoi le nom sterno-cléido-mastoïdien est-il un mémo utile ?",
      "Il cite les trois points : sternum, clavicule, mastoïde",
      [
        "Il décrit les trois chefs du triceps",
        "Il désigne l’épicondyle latéral",
        "Il nomme le transverse",
      ],
      "Le nom = le trajet. Pas besoin d’inventer une autre ancre.",
    ],
    [
      "Tête partie en avant : que se passe-t-il pour les profonds postérieurs ?",
      "Ils travaillent davantage, la tête « pèse » plus",
      [
        "Ils se reposent complètement",
        "Ils tendent alors le coude",
        "Ils deviennent le grand dorsal",
      ],
      "Levier défavorable : plus la tête avance, plus la nappe arrière doit retenir plusieurs kilos.",
    ],
    [
      "Au soulevé de terre, casser le cou vers l’arrière, c’est…",
      "Aller contre la consigne : le cou doit rester dans l’axe du dos",
      [
        "La technique recommandée dans la leçon",
        "Le rôle principal des scalènes",
        "Ce qui isole le biceps",
      ],
      "Ni poitrine (menton rentré à l’excès), ni regard plafond. Prolongement du dos.",
    ],
    [
      "Écraser le menton contre la poitrine sous barre, c’est…",
      "L’autre excès à éviter : le cou n’est plus dans l’axe",
      [
        "La seule consigne de la leçon",
        "Le moyen d’activer le dentelé",
        "Ce qui crée le tennis elbow",
      ],
      "La leçon refuse les deux cassures : avant (poitrine) et arrière.",
    ],
    [
      "Les scalènes sont plus profonds que le SCM. Qu’est-ce que ça change au visuel ?",
      "Le SCM ressort quand tu tournes la tête ; les scalènes se voient moins",
      [
        "Les scalènes forment le galbe du biceps",
        "Le SCM est invisible, les scalènes saillent toujours",
        "Aucun des deux n’est au cou",
      ],
      "Ouverture de la leçon : le muscle qui ressort à la rotation, c’est le SCM, superficiel.",
    ],
    [
      "Inspiration ample : quel couple « cou / côtes » est cité ?",
      "Scalènes qui relient cervicales et premières côtes",
      [
        "Grand pec qui tire l’humérus",
        "Fléchisseurs d’épicondyle médial",
        "Rhomboïdes vers la colonne",
      ],
      "Soulever les 1ères côtes = aide inspiratoire des scalènes, en plus de l’inclinaison du cou.",
    ],
    [
      "Shrugs et gainage impliquent le cou parce que…",
      "Il se gaine : d’où l’alignement avec le dos",
      [
        "Le SCM tend alors le coude",
        "Les scalènes font le V",
        "La tête n’a plus de poids",
      ],
      "On sous-estime le cou en salle. DL, shrugs, gainage le recrutent : autant le tenir dans l’axe.",
    ],
    [
      "Quelle affirmation sur les muscles profonds postérieurs est juste ?",
      "Ils tiennent la tête ; c’est un travail de tous les instants",
      [
        "Ils ne servent qu’à tourner la tête comme le SCM unilatéral",
        "Ils naissent à l’épicondyle latéral",
        "Ils dessinent les tablettes",
      ],
      "Nappe arrière, posture, kilos de la tête — pas le muscle en V de la rotation.",
    ],
    [
      "SCM unilatéral vs scalènes : point commun et différence ?",
      "Les deux peuvent incliner ; le SCM tourne aussi, les scalènes aident à inspirer",
      [
        "Aucun ne touche au cou",
        "Les deux vont à la mastoïde et aux doigts",
        "Seul le SCM relie les cervicales aux côtes",
      ],
      "Inclinaison partagée. Rotation / flexion bilatérale = SCM. Côtes et inspiration = scalènes.",
    ],
    [
      "Quelle synthèse est fidèle à la leçon ?",
      "SCM : mastoïde, uni = tourner/incliner, bi = fléchir ; scalènes : côtes + inspiration ; profonds : tenir ; cou dans l’axe",
      [
        "Le SCM va aux premières côtes ; les scalènes à la mastoïde ; le cou se casse volontairement",
        "Le cou n’a aucun rôle en DL ni en gainage",
        "Les profonds postérieurs poussent la barre au couché",
      ],
      "Trajets, actions uni/bi, respiration, tenue de tête, et la consigne d’alignement : tout le contenu utile de la leçon.",
    ],
  ]),
];
