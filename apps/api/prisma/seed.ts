...
C’est pendant le sommeil que beaucoup de réparation se joue.
Horaires réguliers > gadgets miracles.
Écran intense late = souvent moins bon endormissement.`,
      durationSec: 70,
      difficulty: "BEGINNER",
      order: 0,
      xpReward: 25,
      tags: ["sommeil"],
      quizPrompt: "Pour la récupération musculaire, le sommeil est…",
      quizCorrect: "Un pilier majeur",
      quizWrong: [
        "Optionnel",
        "Remplacé par un café",
        "Inutile si protéines OK",
      ],
      tfPrompt: "Dormir 4 h suffit si les séances sont dures.",
      tfIsTrue: false,
      tfExplanation: "Faux : le déficit de sommeil freine récup et perf.",
    },
    {
...
Courbatures = micro-dommages / inflammation.
Pas un score de qualité d’entraînement.
Trop de DOMS peut juste indiquer un volume mal dosé.`,
      durationSec: 65,
      difficulty: "BEGINNER",
      order: 1,
      xpReward: 25,
      tags: ["doms"],
      quizPrompt: "Les DOMS indiquent…",
      quizCorrect: "Souvent des micro-dommages, pas la qualité des gains",
      quizWrong: [
        "Un PR garanti",
        "Une carence en fer seule",
        "Que tu dois doubler le volume",
      ],
      tfPrompt: "Pas de courbatures = séance inutile.",
      tfIsTrue: false,
      tfExplanation: "Faux : on peut progresser sans DOMS marquées.",
    },
    {
...
Stress pro / vie = fatigue systémique.
Impacte sommeil, faim, motivation.
Marche, respiration, limites claires aident autant qu’un foam roller.`,
      durationSec: 70,
      difficulty: "BEGINNER",
      order: 2,
      xpReward: 25,
      tags: ["stress"],
      quizPrompt: "Le stress chronique peut…",
      quizCorrect: "Freiner la récupération",
      quizWrong: [
        "Remplacer l’échauffement",
        "Augmenter le 1RM magiquement",
        "Hydrater",
      ],
      tfPrompt: "Seul le volume en salle fatigue un athlète.",
      tfIsTrue: false,
      tfExplanation: "Faux : stress de vie compte aussi.",
    },
    {
...
Amplitude + contrôle > étirements passifs infinis.
Cibler les zones qui limitent tes lifts.
5–10 min ciblés battent 40 min aléatoires.`,
      durationSec: 80,
      difficulty: "INTERMEDIATE",
      order: 3,
      xpReward: 30,
      tags: ["mobilite"],
      quizPrompt: "Une bonne mobilité, c’est surtout…",
      quizCorrect: "Une amplitude contrôlée",
      quizWrong: [
        "Toucher ses orteils une fois par an",
        "Éviter tout échauffement",
        "S’étirer 3 h/jour",
      ],
      tfPrompt: "Il faut être contorsionniste pour squatter correctement.",
      tfIsTrue: false,
      tfExplanation: "Faux : amplitude suffisante et contrôle suffisent.",
    },
    {
      title: "Actif recovery",
      subtitle: "Marcher > canapé absolu.",
      markdown: `# Récup active

Marche, mobilité légère, cardio très facile.
Favorise le flux sanguin sans ajouter de fatigue lourde.
Le jour off n’est pas un jour « mort ».`,
      durationSec: 60,
      difficulty: "INTERMEDIATE",
      order: 4,
      xpReward: 30,
      tags: ["recovery"],
      quizPrompt: "Une récupération active typique est…",
      quizCorrect: "Une marche ou mobilité légère",
      quizWrong: [
        "Un max effort deadlift",
        "Un HIIT extrême",
        "Une nuit blanche",
      ],
      tfPrompt: "Le jour off impose l’immobilité totale au lit.",
      tfIsTrue: false,
      tfExplanation: "Faux : le mouvement léger aide souvent.",
    },
    {
      title: "Signaux de surmenage",
      subtitle: "Quand lever le pied.",
      markdown: `# Overreaching

Perf en baisse, humeur, sommeil cassé, petites blessures.
Réponse : volume ↓, sommeil ↑, stress ↓.
Ignorer les signaux = blessure / burnout.`,
      durationSec: 90,
      difficulty: "ADVANCED",
      order: 5,
      xpReward: 35,
      tags: ["surmenage"],
      quizPrompt: "Perf en baisse + sommeil cassé suggère souvent…",
      quizCorrect: "Un besoin de réduire la charge",
      quizWrong: [
        "D’ajouter 10 séries",
        "De supprimer l’eau",
        "D’ignorer totalement",
      ],
      tfPrompt: "La fatigue se règle uniquement en ajoutant plus de caféine.",
      tfIsTrue: false,
      tfExplanation: "Faux : il faut gérer charge et récupération.",
    },
  ],
};
